...
class _PerformanceScreenState extends ConsumerState<PerformanceScreen> {
  ...
  Widget build(BuildContext context) {
    // Performance is YOUR personal trade record only. Real, human-taken
    // positions — bulk-imported Webull history, admin closes, "I took this
    // trade" actions. The scanner's auto-tracked simulated outcomes live on
    // a dedicated screen (RoutePaths.trackRecord) so they don't dilute the
    // user's own P&L. A CTA at the top of the body links to it.
...
// ===========================================================================
//  TRACK RECORD CTA — pushes to the standalone Scanner Track Record screen
            ...
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const SizedBox(height: 2),
                  Text(
                    'What every A / A+ alert would have returned. Simulated.',
                    style: TextStyle(
